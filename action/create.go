...
import (
	...
	"github.com/Khulnasoft-lab/gopkg/dependency"
...
func Create(base string, skipImport, nonInteractive bool) {
	...
	// Write YAML
	msg.Info("Writing configuration file (%s)", gopkgfile)
	...
	if !res {
		msg.Info("You can now edit the gopkg.yaml file. Consider:")
		msg.Info("--> Using versions and ranges. See https://gopkg.sh/docs/versions/")
		msg.Info("--> Adding additional metadata. See https://gopkg.sh/docs/gopkg.yaml/")
