...
// Lockfile represents a gopkg.lock file.
...
// ReadLockFile loads the contents of a gopkg.lock file.
...
func (l Locks) Less(i, j int) bool {
	...
	// example, Khulnasoft-lab comes before kylelemons. Making them lowercase
