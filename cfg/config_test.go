...
import:
  ...
  - package: github.com/Khulnasoft-lab/convert
    repo: git@github.com:Khulnasoft-lab/convert.git
    vcs: git
...
func TestManualConfigFromYaml(t *testing.T) {
	...
	for _, i := range cfg.Imports {
		if i.Name == "github.com/Khulnasoft-lab/convert" {
			found = true
			ref := "a9949121a2e2192ca92fa6dddfeaaa4a4412d955"
			if i.Reference != ref {
...
func TestHasDependency(t *testing.T) {
	...
	if c.HasDependency("github.com/Khulnasoft-lab/convert") != true {
