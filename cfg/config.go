...
import (
	...
	"github.com/Khulnasoft-lab/gopkg/mirrors"
...
func (c *Config) WriteFile(gopkgpath string) error {
	o, err := c.Marshal()
	if err != nil {
		return err
	}
	return ioutil.WriteFile(gopkgpath, o, 0666)
}
...
// GetRepo retrieves a Khulnasoft-lab/vcs repo object configured for the root
